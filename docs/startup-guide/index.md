...
| [BobDyn/BobSim Startup](/startup-guide/bobsim) | You want the complete simulation workspace for setup, cases, sweeps, reports, plots, metrics, and batch studies | The BobSim app running in Docker, with a vehicle saved, written to MBD, and simulated once |
