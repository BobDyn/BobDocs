...
| [BobDyn/BobSim Startup](/startup-guide/bobsim) | You want the complete simulation workspace for setup, cases, sweeps, reports, plots, metrics, and batch studies | The BobSim Docker image built, a first study report, and the app open on your vehicle |
